...
<h1>Управление необработанными заказами</h1>
...
<?}?>
 ...
 <? foreach ($params['child_list'] as $key =>$item ) {
    if (is_numeric($key)){?> 
<div id = 'child_list'>
  	<span id = 'child_name'><a href='/admin/manage_orders/<?=$item['id']?>'>Заказ №<?=$item['id']?> от <?=substr($item['date'],0,10)?> на сумму <?=$item['summ']?></a></span><br/>
</div>
 <?}}}?>
 <?  if (($params['child_list'][0]) && $params['child_list'][max_page]>1) { //  pager  ?>
<div class='pager'><b>Страницы:</b> &nbsp;  
